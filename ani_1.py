...
fig, ax = plt.subplots(figsize=(12, 9))  # widescreen, better for video
fig.subplots_adjust(left=0.05, right=0.99, top=0.98, bottom=0.05)  # reduce white space
fig.suptitle("🚆 Sligo-Dublin Rail Line Simulator 🚆",
...
# start_time = 7 * 3600 + 30 * 60  # 07:30:00 in seconds
